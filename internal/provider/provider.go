...
func (p *MezmoProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewOpenTelemetryCombinedSourceResource,

		// Processors
		NewAggregateProcessorResource,
		NewCompactFieldsProcessorResource,
		NewDataProfilerProcessorResource,
		...
		NewEventToMetricProcessorResource,
		NewFilterProcessorResource,
		NewFlattenFieldsProcessorResource,
		NewMapFieldsProcessorResource,
		NewMetricsTagCardinalityLimitProcessorResource,
		...
		NewTraceSamplingProcessorResource,
		...
		NewGcpCloudMonitoringDestinationResource,
		NewGcpCloudOperationsDestinationResource,
		NewGcpCloudPubSubDestinationResource,
