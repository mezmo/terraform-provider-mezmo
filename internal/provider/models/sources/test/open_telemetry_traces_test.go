		...
		Steps: []resource.TestStep{
			...
			// Import
			{
				Config: GetCachedConfig(cacheKey) + `
					resource "mezmo_open_telemetry_traces_source" "import_target" {
						pipeline_id = mezmo_pipeline.test_parent.id
						title = "my open telemetry traces title"
						description = "my open telemetry traces description"
					}`,
				ImportState:       true,
				ResourceName:      "mezmo_open_telemetry_traces_source.import_target",
				ImportStateIdFunc: ComputeImportId("mezmo_open_telemetry_traces_source.my_source"),
