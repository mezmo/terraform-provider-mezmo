...
func TestAccGcpCloudOperationsSinkResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ExpectError: regexp.MustCompile("The argument \"log_id\" is required"),
			},
			{
				Config: GetProviderConfig() + `
									resource "mezmo_gcp_cloud_operations_destination" "my_dest" {
			...
			},
			{
				...
				ExpectError: regexp.MustCompile("Attribute log_id string length must be at least 1"),
			},
			// Create
			{
