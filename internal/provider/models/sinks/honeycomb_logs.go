...
type HoneycombLogsSinkModel struct {
	Id           String `tfsdk:"id"`
...
func HoneycombLogsFromModel(plan *HoneycombLogsSinkModel, previousState *HoneycombLogsSinkModel) (*Sink, diag.Diagnostics) {
	dd := diag.Diagnostics{}
...
func HoneycombLogsToModel(plan *HoneycombLogsSinkModel, component *Sink) {
