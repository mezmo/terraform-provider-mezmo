...
type DatadogMetricsSinkModel struct {
	Id           String `tfsdk:"id"`
...
func DatadogMetricsFromModel(plan *DatadogMetricsSinkModel, previousState *DatadogMetricsSinkModel) (*Sink, diag.Diagnostics) {
	dd := diag.Diagnostics{}
	component := Sink{
		BaseNode: BaseNode{
...
func DatadogMetricsSinkToModel(plan *DatadogMetricsSinkModel, component *Sink) {
