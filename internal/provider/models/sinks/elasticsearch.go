...
type ElasticSearchSinkModel struct {
	Id           String `tfsdk:"id"`
...
func ElasticSearchSinkResourceSchema() schema.Schema {
	return schema.Schema{
		Description: "Represents an ElasticSearch sink.",
...
func ElasticSearchSinkFromModel(plan *ElasticSearchSinkModel, previousState *ElasticSearchSinkModel) (*Sink, diag.Diagnostics) {
	dd := diag.Diagnostics{}
...
func ElasticSearchSinkToModel(plan *ElasticSearchSinkModel, component *Sink) {
