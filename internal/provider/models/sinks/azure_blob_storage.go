...
type AzureBlobStorageSinkModel struct {
	Id                  String `tfsdk:"id"`
...
func AzureBlobStorageFromModel(plan *AzureBlobStorageSinkModel, previousState *AzureBlobStorageSinkModel) (*Sink, diag.Diagnostics) {
	dd := diag.Diagnostics{}
...
func AzureBlobStorageToModel(plan *AzureBlobStorageSinkModel, component *Sink) {
