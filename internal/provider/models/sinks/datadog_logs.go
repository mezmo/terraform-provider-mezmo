...
type DatadogLogsSinkModel struct {
	Id           String `tfsdk:"id"`
...
func DatadogLogsFromModel(plan *DatadogLogsSinkModel, previousState *DatadogLogsSinkModel) (*Sink, diag.Diagnostics) {
	dd := diag.Diagnostics{}
	component := Sink{
		BaseNode: BaseNode{
			Type:        "datadog-logs",
...
func DatadogLogsSinkToModel(plan *DatadogLogsSinkModel, component *Sink) {
