...
func MezmoSinkResourceSchema() schema.Schema {
	return schema.Schema{
		Description: "Represents a Mezmo sink.",
...
func MezmoSinkFromModel(plan *MezmoSinkModel, previousState *MezmoSinkModel) (*Sink, diag.Diagnostics) {
	dd := diag.Diagnostics{}
...
func MezmoSinkToModel(plan *MezmoSinkModel, component *Sink) {
