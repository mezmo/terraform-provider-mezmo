...
type FlattenFieldsTransformModel struct {
	Id           String `tfsdk:"id"`
...
func FlattenFieldsTransformResourceSchema() schema.Schema {
...
func FlattenFieldsTransformFromModel(plan *FlattenFieldsTransformModel, previousState *FlattenFieldsTransformModel) (*Transform, diag.Diagnostics) {
	dd := diag.Diagnostics{}
	component := Transform{
		BaseNode: BaseNode{
			Type:        "flatten-fields",
...
func FlattenFieldsTransformToModel(plan *FlattenFieldsTransformModel, component *Transform) {
