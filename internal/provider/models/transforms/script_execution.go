...
type ScriptExecutionTransformModel struct {
	Id           String `tfsdk:"id"`
...
func ScriptExecutionTransformResourceSchema() schema.Schema {
...
func ScriptExecutionTransformFromModel(plan *ScriptExecutionTransformModel, previousState *ScriptExecutionTransformModel) (*Transform, diag.Diagnostics) {
	dd := diag.Diagnostics{}
	component := Transform{
		BaseNode: BaseNode{
			Type:        "js-script",
...
func ScriptExecutionTransformToModel(plan *ScriptExecutionTransformModel, component *Transform) {
