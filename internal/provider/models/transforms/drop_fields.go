...
type DropFieldsTransformModel struct {
	Id           String `tfsdk:"id"`
...
func DropFieldsTransformResourceSchema() schema.Schema {
...
func DropFieldsTransformFromModel(plan *DropFieldsTransformModel, previousState *DropFieldsTransformModel) (*Transform, diag.Diagnostics) {
	dd := diag.Diagnostics{}
	component := Transform{
		BaseNode: BaseNode{
			Type:        "drop-fields",
...
func DropFieldsTransformToModel(plan *DropFieldsTransformModel, component *Transform) {
