		...
		Steps: []resource.TestStep{
			// Error: pipeline_id is required
			{
				Config: GetCachedConfig(cacheKey) + `
					resource "mezmo_parse_transform" "my_transform" {
			...
			{
				Config: GetCachedConfig(cacheKey) + `
					resource "mezmo_parse_transform" "csv_parser" {
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestMatchResourceAttr(
						"mezmo_parse_transform.csv_parser", "id", regexp.MustCompile(`[\w-]{36}`)),

					StateHasExpectedValues("mezmo_parse_transform.csv_parser", map[string]any{
						"pipeline_id":                   "#mezmo_pipeline.test_parent.id",
						"title":                         "custom csv parser title",
						"description":                   "custom csv parser desc",
						"generation_id":                 "0",
			...
			{
				Config: GetCachedConfig(cacheKey) + `
					resource "mezmo_parse_transform" "apache_defaults" {
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestMatchResourceAttr(
						"mezmo_parse_transform.apache_defaults", "id", regexp.MustCompile(`[\w-]{36}`)),

					StateHasExpectedValues("mezmo_parse_transform.apache_defaults", map[string]any{
						"pipeline_id":                         "#mezmo_pipeline.test_parent.id",
						"title":                               "apache parser title",
						"description":                         "apache parser desc",
						"generation_id":                       "0",
			...
			{
				Config: GetCachedConfig(cacheKey) + `
					resource "mezmo_parse_transform" "apache_custom_time" {
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestMatchResourceAttr(
						"mezmo_parse_transform.apache_custom_time", "id", regexp.MustCompile(`[\w-]{36}`)),

					StateHasExpectedValues("mezmo_parse_transform.apache_custom_time", map[string]any{
						"pipeline_id":                         "#mezmo_pipeline.test_parent.id",
						"title":                               "custom apache parser title",
						"description":                         "custom apache parser desc",
						"generation_id":                       "0",
