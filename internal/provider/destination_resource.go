...
import (
	...
	. "github.com/mezmo/terraform-provider-mezmo/v5/internal/client"
	. "github.com/mezmo/terraform-provider-mezmo/v5/internal/provider/models/destinations"
)
...
type DestinationModel interface {
	AzureBlobStorageDestinationModel |
		...
		GcpCloudMonitoringDestinationModel |
		GcpCloudOperationsDestinationModel |
		GcpCloudPubSubDestinationModel |
