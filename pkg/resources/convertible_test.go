	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "simple_route.json")
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "route.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "parse_sequentially.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "dedupe.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "drop_fields.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "flatten_fields.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "map_fields.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "parse.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
		...
		},
		{
			...
			args: args{
				...
				model: func() *reflect.Value {
					t.Helper()
					model := loadJsonFile[ProcessorApiModel](t, processorsPath, "reduce.json")
					rModel := reflect.ValueOf(*model)
					return &rModel
				}(),
			},
